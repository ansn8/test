...
<head>
	...
	<title>Recreation by TEMPLATED</title>
	<link href="<c:url value="http://fonts.googleapis.com/css?family=Arvo|Open+Sans:400,300,600,700" />" rel="stylesheet" type="text/css">
	<link href="<c:url value="/resources/css/style.css" />" rel="stylesheet" type="text/css" media="screen">
	<link href="<c:url value="/resources/boot/css/bootstrap.css"/>" rel="stylesheet">
...
<body>
	...
	<!--  <div id="banner"><a href="#"><img src="<c:url value="/resources/images/img01.jpg" />" width="1200" height="300" alt="" /></a></div>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				<div id="content">
					<div class="post">
						<h2 class="title"><a href="#">Welcome to Reaction </a></h2>
						<p class="meta"><span class="date">February 15, 2013</span><span class="posted">Posted by <a href="#">Someone</a></span></p>
						<div style="clear: both;">&nbsp;</div>
						<div class="entry">
							<p>This is <strong>Green Exposure</strong>, a free, fully standards-compliant CSS template designed by <a href="http://templated.co" rel="nofollow">TEMPLATED</a>.  The photo used in this template is from <a href="http://fotogrph.com/">Fotogrph</a>.  This free template is released under the <a href="http://templated.co/license">Creative Commons Attribution</a> license, so you’re pretty much free to do whatever you want with it (even use it commercially) provided you give us credit for it. Have fun :)</p>
